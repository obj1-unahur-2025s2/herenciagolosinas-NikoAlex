...
class CarameloConCorozonDeChocolate inherits Caramelo {
...
class ObleaCrujiente inherits Oblea {
	...
	override method mordisco() {
	  ...
	  if(cantidadMordiscos <=3)peso=peso-3
	}
